      ...
      >
        <template v-slot:table-colgroup="scope">
          <col
            ...
            :style="{
              width:
                field.key === 'index' || field.key === 'tmplManage'
                  ? '20px'
                  : '250px'
            }"
          />
        ...
        <template slot="tmplManage" slot-scope="data">
          <button class="btn btn-primary" @click="openManage(data.value.id)">
            Manage
          </button>
        </template>
      </b-table>
...
import CommissionTemplate from "./components/commission-settings/CommissionTemplate";
